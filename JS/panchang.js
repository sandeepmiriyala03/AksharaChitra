...
var zn = ["మేష","వృషభ","మిథున","కర్కాటక","సింహ","కన్య","తుల","వృశ్చిక","ధనుస్సు","మకర","కుంభ","మీనం"];

var wd = ["ఆది","సోమ","మంగళ","బుధ","గురు","శుక్ర","శని"];

var naks = ["అశ్విని","భరణి","క్రుతిక","రోహిణి","మృగశిర","ఆరవత్ర","పునర్వసు","పుష్య","అశ్లేష","మఖ","పుబ్బ","ఉత్తర","హస్త","చిత్త","స్వాతి","విశాఖ","అనురాధ","జ్యేష్ట","మూల","పూర్వషాఢ","ఉత్తరషాఢ","శ్రవణ","ధనిష్ట","శతభిష","పూర్వభాద్ర","ఉత్తరభాద్ర","రేవతి"];
var tith =["పాడ్యమి","విధియ","థాడియ","చవితి","పంచమి","షష్ఠి","సప్తమి","అష్టమి","నవమి","దశమి","ఏకాదశి","ద్వాదశి","త్రయోదశి","చతుర్దశి","పౌర్ణమి","పాడ్యమి","విధియ","థాడియ","చవితి","పంచమి","షష్ఠి","సప్తమి","అష్టమి","నవమి","దశమి","ఏకాదశి","ద్వాదశి","త్రయోదశి","చతుర్దశి","అమావాస్య"];
var kar = [ "బావ","బలవ","కౌలవ","తైతుల","గరజ","వనిజ","విష్టి","శకున","చతుర్పద","నాగవ","కిమస్టుగ్హన"];
var yog = ["విష్కంభ","పృథి","ఆయుష్మాన్","సౌభాగ్య","శోభన","అతిగండ","శుకర్మణ్","ధృతి","సూళ","గంధ","వృద్ధి","ధ్రువ","వ్యాఘట","హర్ష","వజ్ర","సిద్ధి","వ్యతిపాత","వరియాన్","పరిగ్హ","శివ","సిద్ధ","సాధ్య","శుభ","శుక్ల","బ్రమ్హ","ఇంద్ర","వైద్రుతి"];
...
function getTeluguYear(d) {
            const year = d.getFullYear();
            // 1867 సంవత్సరాన్ని "ప్రభవి" గా తీసుకుని, దాని ప్రకారం ఇండెక్స్ లెక్కించండి.
            const referenceYear = 1867;
            let index = (year - referenceYear) % 60;
            // ప్రతికూల (negative) ఇండెక్స్ ఉంటే సరిచేయండి
            if (index < 0) index += 60;
            return teluguYears[index];
        }
panchang = {
 Day: {},
 Tithi: {},
...
// Paksha calculation - add this block here
let paksha = "";
if (n_tithi >= 0 && n_tithi <= 14) paksha = "శుక్ల పక్షం";
else if (n_tithi >= 15 && n_tithi <= 29) paksha = "కృష్ణ పక్షం";
else paksha = "Unknown పక్షం";

// Tithi name with Paksha prefix
this.Tithi.name = paksha + " - " + tith[n_tithi];

this.Tithi.start = s_tithi.start;
this.Tithi.end = s_tithi.end;

// Set Paksha explicitly
this.Paksha = { name: paksha };
...
var z = floor(abs(fix360(Lmoon + ayanamsa))/30);
    ...
    this.Tithi.start = s_tithi.start;
    this.Tithi.end = s_tithi.end;
    this.teluguYears = getTeluguYear(d); // Add this line
    if (cb) { cb();}
}
}
